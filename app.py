...
import subprocess
from predict import predict_changes
            ...
            if st.button('Submit'):
                ...
                with st.spinner("Generating Predicted and Masked Images..."): 
                    result = subprocess.run(
                        ['python', r'C:\Users\dell\Downloads\AI-Powered Landscape Change Detection\Landscape-Change-Detection\predict.py',
                         '--input', 'temp_images', '--output', 'temp_images', '-t', '0.1', '-c', 'black'],
                        
                    )
                    mask_result = subprocess.run(
                        ['python', r'C:\Users\dell\Downloads\AI-Powered Landscape Change Detection\Landscape-Change-Detection\mask.py'],
                    )
